...
@
    ...
    \part
      ...
      \begin{solution}
        ...
        categorical varibles. However, they are classified as doubles in \texttt{icudat},
        so it is sensible to convert them into factors for certain analyses.
        \par
...
\fi
    ...
    \part
      ...
      \begin{solution}
        ...
        themselves to the ICU (e.g., due to unconsciousness).
        \par
